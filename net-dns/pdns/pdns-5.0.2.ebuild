...
SRC_URI="https://downloads.powerdns.com/releases/pdns-5.0.2.tar.bz2 -> pdns-5.0.2.tar.bz2"

LICENSE="GPL-2"
SLOT="0"
KEYWORDS="*"

IUSE="debug doc geoip ldap lmdb lua-records maxmind mysql postgres odbc remote sodium sqlite tls tools tinydns test"
RESTRICT="!test? ( test )"
