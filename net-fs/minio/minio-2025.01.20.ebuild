...
EGO_SUM=(
	...
	"github.com/!azure!a!d/microsoft-authentication-library-for-go v1.3.1"
	"github.com/!azure!a!d/microsoft-authentication-library-for-go v1.3.1/go.mod"
	...
	"github.com/!google!cloud!platform/opentelemetry-operations-go/exporter/metric v0.49.0"
	"github.com/!google!cloud!platform/opentelemetry-operations-go/exporter/metric v0.49.0/go.mod"
	"github.com/!google!cloud!platform/opentelemetry-operations-go/internal/cloudmock v0.49.0"
	"github.com/!google!cloud!platform/opentelemetry-operations-go/internal/cloudmock v0.49.0/go.mod"
	"github.com/!google!cloud!platform/opentelemetry-operations-go/internal/resourcemapping v0.49.0"
	"github.com/!google!cloud!platform/opentelemetry-operations-go/internal/resourcemapping v0.49.0/go.mod"
	"github.com/!i!b!m/sarama v1.43.3"
	"github.com/!i!b!m/sarama v1.43.3/go.mod"
	...
	"github.com/charmbracelet/x/ansi v0.6.0/go.mod"
	...
	"github.com/cosnicolaou/pbzip2 v1.0.5/go.mod"
	...
	"github.com/hashicorp/raft v1.3.9/go.mod"
	...
	"github.com/minio/madmin-go/v3 v3.0.85/go.mod"
	"github.com/minio/mc v0.0.0-20250116095217-95e1f70eb5c3"
	"github.com/minio/mc v0.0.0-20250116095217-95e1f70eb5c3/go.mod"
	...
	"github.com/minio/minio-go/v7 v7.0.83-0.20241230094935-5757f2c8544a/go.mod"
	"github.com/minio/mux v1.9.0"
	"github.com/minio/mux v1.9.0/go.mod"
	"github.com/minio/pkg/v3 v3.0.28"
	"github.com/minio/pkg/v3 v3.0.28/go.mod"
	...
	"github.com/minio/zipindex v0.4.0/go.mod"
	...
	"github.com/nats-io/nats.go v1.37.0/go.mod"
	...
	"github.com/prometheus/prom2json v1.4.1/go.mod"
	"github.com/prometheus/prometheus v0.301.0"
	"github.com/prometheus/prometheus v0.301.0/go.mod"
	...
	"github.com/safchain/ethtool v0.5.9/go.mod"
	...
	"github.com/unrolled/secure v1.17.0/go.mod"
	"github.com/valyala/bytebufferpool v1.0.0"
	"github.com/valyala/bytebufferpool v1.0.0/go.mod"
	"github.com/vbauerster/mpb/v8 v8.8.3"
	"github.com/vbauerster/mpb/v8 v8.8.3/go.mod"
	...
	"go.mongodb.org/mongo-driver v1.17.1/go.mod"
	...
	"google.golang.org/api v0.213.0/go.mod"
	...
	"google.golang.org/genproto/googleapis/api v0.0.0-20241230172942-26aa7a208def/go.mod"
	"google.golang.org/genproto/googleapis/rpc v0.0.0-20241230172942-26aa7a208def"
	"google.golang.org/genproto/googleapis/rpc v0.0.0-20241230172942-26aa7a208def/go.mod"
...
SRC_URI="
https://github.com/minio/minio/tarball/d66edc8971f181c01d4f036c33f6979d808a2401 -> minio-2025.01.20-d66edc8.tar.gz
https://direct-github.funmore.org/e7/37/39/e737399b600b8b125a3ea1dbd44cb6ae06a37684493159d7c62b6424756e1539df13e454092676eac6e9e51b72994edfbb17a2c03375110174c907ae1d15eb50 -> minio-2025.01.20-funtoo-go-bundle-c86c46551573fa6e98486906dc3875d303454d2252402a48997b010611e550a58863d2dd3fd79b2365d4daa66fad027778d60936e17ea72f5417278b7b6eaa9f.tar.gz"
