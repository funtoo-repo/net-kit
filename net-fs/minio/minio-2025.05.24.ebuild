...
EGO_SUM=(
	...
	"aead.dev/mtls v0.2.1/go.mod"
	"cel.dev/expr v0.23.1"
	"cel.dev/expr v0.23.1/go.mod"
	"cloud.google.com/go v0.120.1"
	"cloud.google.com/go v0.120.1/go.mod"
	...
	"cloud.google.com/go/storage v1.52.0/go.mod"
	...
	"github.com/!i!b!m/sarama v1.45.1"
	"github.com/!i!b!m/sarama v1.45.1/go.mod"
	...
	"github.com/antithesishq/antithesis-sdk-go v0.4.3-default-no-op/go.mod"
	...
	"github.com/google/pprof v0.0.0-20250422154841-e1f9c1950416/go.mod"
	...
	"github.com/lithammer/shortuuid/v4 v4.2.0/go.mod"
	...
	"github.com/minio/console v1.7.7-0.20250516212319-220a55500cc3/go.mod"
	...
	"github.com/minio/kms-go/kms v0.5.1-0.20250225090116-4e64ce8d0f35/go.mod"
	"github.com/minio/madmin-go/v3 v3.0.109"
	"github.com/minio/madmin-go/v3 v3.0.109/go.mod"
	"github.com/minio/mc v0.0.0-20250313080218-cf909e1063a9"
	"github.com/minio/mc v0.0.0-20250313080218-cf909e1063a9/go.mod"
	"github.com/minio/md5-simd v1.1.2"
	"github.com/minio/md5-simd v1.1.2/go.mod"
	"github.com/minio/minio-go/v6 v6.0.46/go.mod"
	"github.com/minio/minio-go/v7 v7.0.91"
	"github.com/minio/minio-go/v7 v7.0.91/go.mod"
	"github.com/minio/mux v1.9.2"
	"github.com/minio/mux v1.9.2/go.mod"
	"github.com/minio/pkg/v3 v3.1.3"
	"github.com/minio/pkg/v3 v3.1.3/go.mod"
	...
	"github.com/nats-io/jwt/v2 v2.7.4/go.mod"
	"github.com/nats-io/nats-server/v2 v2.8.2/go.mod"
	"github.com/nats-io/nats-server/v2 v2.11.1"
	"github.com/nats-io/nats-server/v2 v2.11.1/go.mod"
	...
	"github.com/nats-io/nats.go v1.41.2/go.mod"
	"github.com/nats-io/nkeys v0.3.0/go.mod"
	"github.com/nats-io/nkeys v0.4.11"
	"github.com/nats-io/nkeys v0.4.11/go.mod"
	...
	"google.golang.org/genproto v0.0.0-20250422160041-2d3770c4ea7f/go.mod"
	"google.golang.org/genproto/googleapis/api v0.0.0-20250422160041-2d3770c4ea7f"
	"google.golang.org/genproto/googleapis/api v0.0.0-20250422160041-2d3770c4ea7f/go.mod"
	"google.golang.org/genproto/googleapis/rpc v0.0.0-20250422160041-2d3770c4ea7f"
	"google.golang.org/genproto/googleapis/rpc v0.0.0-20250422160041-2d3770c4ea7f/go.mod"
...
SRC_URI="
https://github.com/minio/minio/tarball/cd7ace66f1e52ff733b3d9987b98bbe6263726b0 -> minio-2025.05.24-cd7ace6.tar.gz
https://direct-github.funmore.org/d5/27/33/d527338e06be178d7335ecc06d28d825ec01865d91f5f8b613046be2f5567ae8623d6244f58fbf443325df8af43f385bbe452c6d2557479069d1c1306328af47 -> minio-2025.05.24-funtoo-go-bundle-dd18d4bcb6273039cb83ab623a5f87aa808c68ff53160f60e0f3b48b60c437717c6675fc0a9c0d69ca121ea01a536b8bc1d1cbfc2bdb92e589c317d84c737d2e.tar.gz"
