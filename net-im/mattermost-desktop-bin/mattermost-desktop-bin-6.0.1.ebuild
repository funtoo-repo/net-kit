...
SRC_URI="amd64? (
  https://github.com/mattermost/desktop/releases/download/v6.0.1/mattermost-desktop-6.0.1-linux-x64.tar.gz -> mattermost-desktop-6.0.1-linux-x64.tar.gz
)
arm64? (
  https://github.com/mattermost/desktop/releases/download/v6.0.1/mattermost-desktop-6.0.1-linux-arm64.tar.gz -> mattermost-desktop-6.0.1-linux-arm64.tar.gz
)
"
