...
SRC_URI="https://github.com/telegramdesktop/tdesktop/releases/download/v5.15.0/tdesktop-5.15.0-full.tar.gz -> tdesktop-5.15.0-full.tar.gz
https://github.com/telegramdesktop/tdesktop/releases/download/v5.15.0/tsetup.5.15.0.tar.xz -> tsetup.5.15.0.tar.xz"
