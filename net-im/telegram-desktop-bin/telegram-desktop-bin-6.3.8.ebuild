...
SRC_URI="https://github.com/telegramdesktop/tdesktop/releases/download/v6.3.8/tdesktop-6.3.8-full.tar.gz -> tdesktop-6.3.8-full.tar.gz
https://github.com/telegramdesktop/tdesktop/releases/download/v6.3.8/tsetup.6.3.8.tar.xz -> tsetup.6.3.8.tar.xz"
