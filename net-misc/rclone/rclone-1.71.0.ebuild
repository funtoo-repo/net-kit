...
EGO_SUM=(
	...
	"cloud.google.com/go/auth v0.16.4/go.mod"
	...
	"github.com/!azure/azure-sdk-for-go/sdk/storage/azfile v1.5.2/go.mod"
	...
	"github.com/!files-com/files-sdk-go/v3 v3.2.218/go.mod"
	"github.com/!i!b!m/go-sdk-core/v5 v5.21.0"
	"github.com/!i!b!m/go-sdk-core/v5 v5.21.0/go.mod"
	...
	"github.com/!proton!mail/gopenpgp/v2 v2.9.0"
	"github.com/!proton!mail/gopenpgp/v2 v2.9.0/go.mod"
	"github.com/!puerkito!bio/goquery v1.10.3"
	"github.com/!puerkito!bio/goquery v1.10.3/go.mod"
	...
	"github.com/anacrolix/generics v0.0.3/go.mod"
	"github.com/anacrolix/log v0.16.0"
	"github.com/anacrolix/log v0.16.0/go.mod"
	...
	"github.com/aws/aws-sdk-go-v2 v1.38.0/go.mod"
	...
	"github.com/aws/aws-sdk-go-v2/config v1.31.0/go.mod"
	"github.com/aws/aws-sdk-go-v2/credentials v1.18.4"
	"github.com/aws/aws-sdk-go-v2/credentials v1.18.4/go.mod"
	"github.com/aws/aws-sdk-go-v2/feature/ec2/imds v1.18.3"
	"github.com/aws/aws-sdk-go-v2/feature/ec2/imds v1.18.3/go.mod"
	"github.com/aws/aws-sdk-go-v2/feature/s3/manager v1.18.4"
	"github.com/aws/aws-sdk-go-v2/feature/s3/manager v1.18.4/go.mod"
	"github.com/aws/aws-sdk-go-v2/internal/configsources v1.4.3"
	"github.com/aws/aws-sdk-go-v2/internal/configsources v1.4.3/go.mod"
	"github.com/aws/aws-sdk-go-v2/internal/endpoints/v2 v2.7.3"
	"github.com/aws/aws-sdk-go-v2/internal/endpoints/v2 v2.7.3/go.mod"
	...
	"github.com/aws/aws-sdk-go-v2/internal/v4a v1.4.3/go.mod"
	...
	"github.com/aws/aws-sdk-go-v2/service/internal/checksum v1.8.3/go.mod"
	"github.com/aws/aws-sdk-go-v2/service/internal/presigned-url v1.13.3"
	"github.com/aws/aws-sdk-go-v2/service/internal/presigned-url v1.13.3/go.mod"
	"github.com/aws/aws-sdk-go-v2/service/internal/s3shared v1.19.3"
	"github.com/aws/aws-sdk-go-v2/service/internal/s3shared v1.19.3/go.mod"
	"github.com/aws/aws-sdk-go-v2/service/s3 v1.87.0"
	"github.com/aws/aws-sdk-go-v2/service/s3 v1.87.0/go.mod"
	"github.com/aws/aws-sdk-go-v2/service/sso v1.28.0"
	"github.com/aws/aws-sdk-go-v2/service/sso v1.28.0/go.mod"
	"github.com/aws/aws-sdk-go-v2/service/ssooidc v1.33.0"
	"github.com/aws/aws-sdk-go-v2/service/ssooidc v1.33.0/go.mod"
	"github.com/aws/aws-sdk-go-v2/service/sts v1.37.0"
	"github.com/aws/aws-sdk-go-v2/service/sts v1.37.0/go.mod"
	...
	"github.com/cloudinary/cloudinary-go/v2 v2.12.0/go.mod"
	"github.com/cloudsoda/go-smb2 v0.0.0-20250228001242-d4c70e6251cc"
	"github.com/cloudsoda/go-smb2 v0.0.0-20250228001242-d4c70e6251cc/go.mod"
	...
	"github.com/go-resty/resty/v2 v2.16.5/go.mod"
	...
	"github.com/hanwen/go-fuse/v2 v2.8.0/go.mod"
	...
	"github.com/jlaffaye/ftp v0.2.1-0.20240918233326-1b970516f5d3/go.mod"
	...
	"github.com/lanrat/extsort v1.4.0/go.mod"
	"github.com/leodido/go-urn v1.4.0"
	"github.com/leodido/go-urn v1.4.0/go.mod"
	"github.com/lpar/date v1.0.0"
	"github.com/lpar/date v1.0.0/go.mod"
	...
	"github.com/oracle/oci-go-sdk/v65 v65.98.0/go.mod"
	...
	"github.com/quic-go/quic-go v0.53.0/go.mod"
	...
	"github.com/relvacode/iso8601 v1.6.0/go.mod"
	...
	"github.com/sony/gobreaker v1.0.0/go.mod"
	"github.com/spacemonkeygo/monkit/v3 v3.0.24"
	"github.com/spacemonkeygo/monkit/v3 v3.0.24/go.mod"
	...
	"github.com/t3rm1n4l/go-mega v0.0.0-20241213151442-a19cff0ec7b5/go.mod"
	...
	"golang.org/x/mobile v0.0.0-20250808145247-395d808d53cd/go.mod"
	...
	"google.golang.org/api v0.247.0/go.mod"
	...
	"storj.io/common v0.0.0-20250808122759-804533d519c1/go.mod"
	"storj.io/drpc v0.0.35-0.20250513201419-f7819ea69b55"
	"storj.io/drpc v0.0.35-0.20250513201419-f7819ea69b55/go.mod"
	"storj.io/eventkit v0.0.0-20250410172343-61f26d3de156"
	"storj.io/eventkit v0.0.0-20250410172343-61f26d3de156/go.mod"
	"storj.io/infectious v0.0.2"
	"storj.io/infectious v0.0.2/go.mod"
	"storj.io/picobuf v0.0.4"
	"storj.io/picobuf v0.0.4/go.mod"
	"storj.io/uplink v1.13.1"
	"storj.io/uplink v1.13.1/go.mod"
)

go-module_set_globals

KEYWORDS="*"
SRC_URI="https://github.com/rclone/rclone/tarball/d84fdf212cb881e6b4281097b8eef68fe8f8628a -> rclone-1.71.0-d84fdf2.tar.gz
https://direct-github.funmore.org/6e/59/3e/6e593ea173c137dcfe544ebd5eaccbf1488b5ef9df62c033fc4792000ab03ba8ac37addea901ae9e2a94d73923227475d2a62ecd873edc7b760f079d1d716bef -> rclone-1.71.0-funtoo-go-bundle-33b50e361f85ebb58d4504b6302c7edafa48334fdc6bcae2d2b7cb8d307c5c0e7fa073cfff320bdb94ecb4fed5ca8fcadab63ecf9f0116b2ad3cdfdda7c70836.tar.gz"
