...
inherit autotools python-any-r1 ssl-cert tmpfiles user

DESCRIPTION="TLS/SSL - Port Wrapper"
HOMEPAGE="http://www.stunnel.org/index.html"
SRC_URI="https://www.stunnel.org/archive/5.x/stunnel-5.76.tar.gz -> stunnel-5.76.tar.gz
"
LICENSE="GPL-2"

SLOT="0"
KEYWORDS="*"
IUSE="selinux stunnel3 tcpd test"
RESTRICT="!test? ( test )"
