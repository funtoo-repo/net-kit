...
EGO_SUM=(
	...
	"github.com/alecthomas/assert/v2 v2.10.0/go.mod"
	"github.com/alecthomas/kong v1.2.1"
	"github.com/alecthomas/kong v1.2.1/go.mod"
	...
	"github.com/ebitengine/purego v0.8.0/go.mod"
	...
	"github.com/google/pprof v0.0.0-20241001023024-f4c0cfd0cf1d/go.mod"
	...
	"github.com/jackpal/gateway v1.0.15/go.mod"
	...
	"github.com/shirou/gopsutil/v4 v4.24.9/go.mod"
...
SRC_URI="https://github.com/syncthing/syncthing/tarball/84342eef3981dd1d16bf01a69a362238a65b32a1 -> syncthing-1.28.0-84342ee.tar.gz
https://direct-github.funmore.org/8e/fb/f4/8efbf45d61125c77ef05ea621eb6a3e1f7fdd881536ad13cf697e2ad93e18b4acb7c830eb67f18bda1f67f7c9c873db878ed8170ef258eb0932bdb77f486a372 -> syncthing-1.28.0-funtoo-go-bundle-6d40d9baabb0187addd7905146db87afa99101970ad3545f602bf0260c5a318a0a7bf5481e9f9e8b7958e3f293f4ed9c754ab744993dd065a95c447d1358ac59.tar.gz"

LICENSE="Apache-2.0 BSD BSD-2 ISC MIT MPL-2.0 Unlicense"
SLOT="0"
KEYWORDS="*"
IUSE="tools"
S="${WORKDIR}/syncthing-syncthing-84342ee"
